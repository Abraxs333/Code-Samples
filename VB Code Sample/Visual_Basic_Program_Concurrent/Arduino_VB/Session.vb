...
Public Class session
    ...
    Public Previous_Response As Integer = 2
    Public Actual_Response As Integer = 2
    Public Active As Boolean = True

    Public Previous_Response2 As Integer = 2
    Public Actual_Response2 As Integer = 2
    ...
    Function Data_Handling() As Integer
        ...
        Try
            ...
            If (Actual_Response <> Previous_Response And Actual_Response = 0) Then
                ...
                TXT.WriteLine(Time_in_milliseconds() & ".100")
            ...
            If (Actual_Response2 <> Previous_Response2 And Actual_Response2 = 0) Then
                ...
                TXT.WriteLine(Time_in_milliseconds() & ".300")
    ...
    Private Sub Reinfbtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Reinfbtn.Click
        Arduino.WriteLine("R")
        TXT.WriteLine(Time_in_milliseconds() & ".555")
    ...
    Function Reinforce2() As Integer
        ...
        Arduino.WriteLine("R")
        TXT.WriteLine(Time_in_milliseconds() & ".700")
    ...
    End Function
    Function Time_in_milliseconds() As Integer
    ...
    Function Initialize_File_Writing() As Integer
        ...
        TXT.WriteLine()
        TXT.WriteLine("100 = Response_1 ON")
        TXT.WriteLine("300 = Response_2 ON")
        TXT.WriteLine("500 = Reinforcer1 delivery")
        TXT.WriteLine("700 = Reinforcer2 delivery")
    ...
    Function End_File_Writing() As Integer
        ...
        TXT.WriteLine()
        TXT.WriteLine("Total Responses 1: " + Total_Responses.ToString())
        TXT.WriteLine("Total Responses 2: " + Total_Responses2.ToString())
        TXT.WriteLine("Total Reinforcers 1 delivered: " + Total_Reinforcers.ToString())
        TXT.WriteLine("Total Reinforcers 2 delivered: " + Total_Reinforcers2.ToString())
